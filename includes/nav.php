    ...
    <!-- Add google analytics id here. e.g ?id=UA-123456789-0 -->
    <!-- <script async src="https://www.googletagmanager.com/gtag/js?id=UA-123456789-1"></script> -->
</head>
<body>
    <nav class="navbar navbar-light navbar-expand-xl bg-white mb-4 border-bottom">
        <a href="./" title="Warrington Dog Walkers - Home"><img src="./img/logo_custom.jpg" class="navbar-brand" alt="Warrington Dog Walkers - Logo"></a>
