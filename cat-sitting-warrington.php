...
<?php include('./includes/nav.php'); ?>
    ...
    <div class="container mb-4">
        <div class="row">
            <div class="col">
                <h1 class="display-4 main-heading my-4"><i class="icofont-paw d-none d-sm-inline"></i> Cat Sitting Services</h1>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col">
                <img src="./img/smileyCat.jpg" class="img-fluid" alt="Smiley Cat">
            </div>
        </div>
    </div>
